...
lock, use the Proposal Config's canonical Nervos DAO code hash and hash type, and
contain eight zero data bytes (deposit phase). The Proposal carries no duplicate
